...
export const MainCookies = ({h2,h3,h4,h5,name})=>{
  ...
  function close() {
    ...
    return(
        ...
        <div className="parent-main-cookies">
            <div className="leftCategories">
            <LeftCategories sousBlocProfile={sousBlocProfile}/>
            </div>
                {/*<MainSection mainArticle={mainArticle} h2="Mes Derniers Achats" h3="Mes Promotions" h4="Vous aimerez peut-être aussi" h5=" Les Tendances"/>*/}
                <div
                  style={mainArticle}
                  onClick={handleClickOutside}
                  className="main-article-section1 main-article-section1-responsive"
            >
